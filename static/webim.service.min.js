(function(v,u,X){function ga(){return(new Date).getTime()}function S(c){return w.call(c)==="[object Function]"}function U(c){return w.call(c)==="[object Array]"}function ha(c){return c&&w.call(c)==="[object Object]"}function V(c){return(c||"").replace(/^\s+|\s+$/g,"")}function D(c,e){var g=false;if(ha(e)){c=c||{};for(var h in e){var j=e[h];if(c[h]!=j){g=g||{};g[h]=j}}}return g}function E(c){var e=[];if(c!=null){var g=c.length;if(g==null||typeof c==="string"||S(c)||c.setInterval)e[0]=c;else for(;g;)e[--g]=
c[g]}return e}function z(){var c=arguments[0]||{},e=1,g=arguments.length,h=false,j;if(typeof c==="boolean"){h=c;c=arguments[1]||{};e=2}if(typeof c!=="object"&&!S(c))c={};for(;e<g;e++)if((j=arguments[e])!=null)for(var l in j){var r=c[l],s=j[l];if(c!==s)if(h&&s&&typeof s==="object"&&!s.nodeType)c[l]=z(h,r||(s.length!=null?[]:{}),s);else if(s!==X)c[l]=s}return c}function H(c,e,g){var h,j=0,l=c.length,r=l===X||S(c);if(g)if(r)for(h in c){if(e.apply(c[h],g)===false)break}else for(;j<l;){if(e.apply(c[j++],
...
setTimeout(function(){o&&!s&&W("timeout")},c.timeout)}try{o.send(j==="POST"||j==="PUT"?c.data:null)}catch(qa){if(c.error)c.error.call(c.context||v,o,null,qa)}c.async||W();return o}function ka(){}function t(c){function e(){s=true;v[j]=X;try{delete v[j]}catch(o){}r.onload=r.onreadystatechange=null;l&&r.parentNode&&l.removeChild(r)}c=z({},c);var g=""+L(c.data),h=c.context||v,j="jsonp"+la++,l=u.getElementsByTagName("head")[0]||u.documentElement,r=u.createElement("script");g=(g?g+"&":"")+(c.jsonp||"callback")+
"="+j;c.url+=(F.test(c.url)?"&":"?")+g;r.src=c.url;if(c.scriptCharset)r.charset=c.scriptCharset;var s=false;v[j]=function(o){c.success&&c.success.call(h,o,"success");e()};r.onload=r.onreadystatechange=function(){if(!s&&(!this.readyState||this.readyState==="loaded"||this.readyState==="complete")){c.error&&c.error.call(h,"error");e()}};c.timeout>0&&setTimeout(function(){if(!s){c.error&&c.error.call(h,"timeout");e();v[j]=ka}},c.timeout);l.insertBefore(r,l.firstChild);return X}function Q(c,e){this._setting();
...
"";u.cookie=[c,"=",encodeURIComponent(e),h,j,l,g].join("")}else{e=null;if(u.cookie&&u.cookie!=""){g=u.cookie.split(";");for(h=0;h<g.length;h++){j=V(g[h]);if(j.substring(0,c.length+1)==c+"="){e=decodeURIComponent(j.substring(c.length+1));break}}}return e}}function aa(c,e){if(fa){var g=new Date,h=["[",g.getHours(),":",g.getMinutes(),":",g.getSeconds(),"-",g.getMilliseconds(),"]"].join("");g=h+e+N.encode(c);v.console&&v.console.log(h,e,c);h=u.getElementById("webim-log")||u.body;v.air&&v.air.trace(g);
if(h){var j=u.createElement("P");j.innerHTML=g;h.appendChild(j)}}}function J(c,e){this.options=z({},J.defaults,e);this._init(c,e)}function pa(c){return c&&c.split?c.split(","):U(c)?c:parseInt(c)?[parseInt(c)]:[]}function K(c,e,g){function h(j,l){this.data=j;this.options=z({},h.defaults,l);S(this._init)&&this._init()}h.defaults=e;z(h.prototype,y,g);J[c]=h}var w=Object.prototype.toString,y={option:function(c,e){var g=c;this.options=this.options||{};if(typeof c=="string"){if(e===X)return this.options[c];
g={};g[c]=e}z(this.options,g);return this},bind:function(c,e){var g=this._events=this._events||{};if(S(e)){g[c]=g[c]||[];g[c].push(e)}return this},trigger:function(c,e){var g=(this._events=this._events||{})[c];if(!g)return this;e=U(e)?e:E(e);for(var h=0,j=g.length;h<j;h++)g[h].apply(this,e);return this},unbind:function(c,e){var g=this._events=this._events||{};if(!g[c])return this;if(S(e)){g=g[c];for(var h=g.length;h--;)if(g[h]===e||g[h]===e._proxy)g.splice(h,1)}else delete g[c];return this},one:function(c,
e){if(!S(e))return this;var g=this,h=e._proxy=fun._proxy||function(){g.unbind(c,h);return e.apply(this,arguments)};g.bind(c,h)}},la=ga(),F=/\?/,T=/(\?|&)_=.*?(&|$)/,ma=/%20/g,Z={url:location.href,global:true,type:"GET",contentType:"application/x-www-form-urlencoded",processData:true,async:true,xhr:function(){return v.ActiveXObject?new ActiveXObject("Microsoft.XMLHTTP"):new XMLHttpRequest},accepts:{xml:"application/xml, text/xml",html:"text/html",script:"text/javascript, application/javascript",json:"application/json, text/javascript",
...
{active:this.status.get("b")});this.room=new J.room(null,{user:c});this.history=new J.history(null,{user:c});this.connection=new Q(null,{jsonp:true});this._initEvents()},user:function(c){z(this.data.user,c)},_ready:function(c){var e=this;e._unloadFun=v.onbeforeunload;v.onbeforeunload=function(){e._refresh()};e.trigger("ready",[c])},_go:function(){var c=this.data,e=this.history,g=this.buddy,h=this.room;e.option("userInfo",c.user);H(c.buddies,function(l,r){e.init("unicast",r.id,r.history)});g.handle(c.buddies);
H(c.rooms,function(l,r){e.init("multicast",r.id,r.history)});g=this.setting.get("blocked_rooms");var j=c.rooms;U(g)&&j&&H(g,function(l,r){j[r]&&(j[r].blocked=true)});h.handle(j);h.options.ticket=c.connection.ticket;this.trigger("go",[c]);this.connection.connect(c.connection);if((c=c.new_messages)&&c.length){H(c,function(l,r){r["new"]=true});this.trigger("message",[c])}},_stop:function(c){v.onbeforeunload=this._unloadFun;this.data.user.presence="offline";this.data.user.show="unavailable";this.buddy.clear();
this.trigger("stop",c)},autoOnline:function(){return!this.status.get("o")},_initEvents:function(){function c(j){var l={id:j.from,presence:j.type};if(j.show)l.show=j.show;if(j.nick)l.nick=j.nick;return l}var e=this,g=e.history,h=e.buddy;e.connection.bind("connect",function(){}).bind("data",function(j){e.handle(j)}).bind("error",function(){e._stop("connect error")}).bind("close",function(){e._stop("disconnect")});e.bind("message",function(j){for(var l=[],r=j.length,s=e.data.user.id,o,P,W,G=0;G<r;G++){o=
j[G];W=o.type;P=W=="unicast"?o.to==s?o.from:o.to:o.to;o.id=P;if(W=="unicast"&&!o["new"]){P={id:P,presence:"online"};if(o.nick)P.nick=o.nick;l.push(P)}}if(l.length){h.presence(l);h.complete()}g.handle(j)});e.bind("presence",function(j){h.presence(ia(j,c))})},handle:function(c){c.messages&&c.messages.length&&this.trigger("message",[c.messages]);c.presences&&c.presences.length&&this.trigger("presence",[c.presences]);c.statuses&&c.statuses.length&&this.trigger("status",[c.statuses])},sendMsg:function(c){c.ticket=
this.data.connection.ticket;x({type:"post",url:this.options.urls.message,cache:false,data:c})},sendStatus:function(c){c.ticket=this.data.connection.ticket;x({type:"post",url:this.options.urls.status,cache:false,data:c})},sendPresence:function(c){c.ticket=this.data.connection.ticket;this.data.user.show=c.show;this.status.set("s",c.show);x({type:"post",url:this.options.urls.presence,cache:false,data:c})},online:function(c){var e=this,g=e.status,h=[],j=[],l=g.get("tabs"),r=g.get("tabIds");r&&r.length&&
l&&H(l,function(s){s[0]=="b"&&h.push(s.slice(2));s[0]=="r"&&j.push(s.slice(2))});c=z({buddy_ids:h.join(","),room_ids:j.join(","),show:g.get("s")||"available"},c);e._ready(c);g.set("o",false);g.set("s",c.show);x({type:"post",dataType:"json",data:c,url:e.options.urls.online,success:function(s){if(!s||!s.user||!s.connection)e._stop("online error");else{s.user=z(e.data.user,s.user,{presence:"online"});e.data=s;e._go()}},error:function(){e._stop("online error")}})},offline:function(){var c=this.data;this.status.set("o",
true);this.connection.close();this._stop("offline");x({type:"post",url:this.options.urls.offline,type:"post",cache:false,data:{status:"offline",ticket:c.connection.ticket}})},_refresh:function(){var c=this.data;!c||!c.connection||!c.connection.ticket||x({type:"post",url:this.options.urls.refresh,type:"post",cache:false,data:{ticket:c.connection.ticket}})}});v.webim=J;z(J,{version:"1.0.1",defaults:{urls:{online:"webim/online",offline:"webim/offline",message:"webim/message",presence:"webim/presence",
refresh:"webim/refresh",status:"webim/status"}},log:aa,idsArray:pa,now:ga,isFunction:S,isArray:U,isObject:ha,trim:V,makeArray:E,extend:z,each:H,inArray:function(c,e){for(var g=0,h=e.length;g<h;g++)if(e[g]===c)return g;return-1},grep:function(c,e,g){for(var h=[],j=0,l=c.length;j<l;j++)!g!==!e(c[j],j)&&h.push(c[j]);return h},map:ia,JSON:N,ajax:x,comet:Q,model:K,objectExtend:y});K("setting",{url:"/webim/setting",data:{blocked_rooms:[],play_sound:true,buddy_sticky:true,minimize_layout:true,msg_auto_pop:true}},
{_init:function(){this.data=z({},this.options.data,this.data)},get:function(c){return this.data[c]},set:function(c,e){var g=this,h=c;if(c){if(typeof c=="string"){h={};h[c]=e}var j=g.data,l=D(j,h);if(l){H(l,function(r,s){g.trigger("update",[r,s])});h=z({},j,h);g.data=h;x({type:"post",url:g.options.url,dataType:"json",cache:false,data:{data:N.encode(h)}})}}}});K("status",{key:"_webim"},{_init:function(){var c=this.data;if(c)this._save(c);else this.data=(c=ea(this.options.key))?N.decode(c):{}},set:function(c,
e){var g=c;if(typeof c=="string"){g={};g[c]=e}var h=this.data;D(h,g)&&this._save(z({},h,g))},get:function(c){return this.data[c]},clear:function(){this._save({})},_save:function(c){this.data=c;ea(this.options.key,N.encode(c),{path:"/",domain:u.domain})}});K("buddy",{url:"/webim/buddy"},{_init:function(){this.data=this.data||[];this.dataHash={};this.handle(this.data)},clear:function(){this.data=[];this.dataHash={}},count:function(c){var e=this.dataHash,g=0,h;for(var j in e)if(ha(c)){h=true;for(var l in c)if(c[l]!=
e[j][l])h=false;h&&g++}else g++;return g},get:function(c){return this.dataHash[c]},complete:function(){var c=this.dataHash,e=[],g;for(var h in c){g=c[h];g.incomplete&&g.presence=="online"&&e.push(h)}this.load(e)},update:function(c){this.load(c)},presence:function(c){var e=this.dataHash;c=U(c)?c:[c];for(var g in c){var h=c[g];h.presence=h.presence=="offline"?"offline":"online";h.incomplete=!e[h.id]}this.handle(c)},load:function(c){c=pa(c);c.length&&x({type:"get",url:this.options.url,cache:false,dataType:"json",
...
l)}}},_triggerMsg:function(c,e,g){this.trigger(c,[e,g])},clear:function(c,e){var g=this.options;this.data[c][e]=[];this.trigger("clear",[c,e]);x({url:g.urls.clear,type:"post",cache:false,data:{type:c,id:e}})},init:function(c,e,g){if(U(g)){this.data[c][e]=g;this._triggerMsg(c,e,g)}},load:function(c,e){var g=this,h=g.options;g.data[c][e]=[];x({url:h.urls.load,cache:false,type:"get",dataType:"json",data:{type:c,id:e},success:function(j){g.init(c,e,j)}})}})})(window,document);
(function(v,u,X){function ga(){return false}function S(a){var b="";if(a.length==0)return"";b=a.replace(/&/g,"&gt;");b=b.replace(/</g,"&lt;");b=b.replace(/>/g,"&gt;");b=b.replace(/    /g,"&nbsp;");b=b.replace(/\'/g,"&#39;");b=b.replace(/\"/g,"&quot;");return b=b.replace(/\n/g,"<br />")}function U(a){return/^http:\/\/[A-Za-z0-9]+\.[A-Za-z0-9]+[\/=\?%\-&_~`@[\]\':+!]*([^<>\"])*$/.test(a)}function ha(a,b){for(var d=[];a;a=a.nextSibling)a.nodeType==1&&a!=b&&d.push(a);return d}function V(a,b){return a&&
RegExp("(^|\\s+)"+b+"(\\s+|$)").test(a.className)}function D(a,b){if(a)V(a,b)||(a.className+=" "+b)}function E(a,b){a&&(a.className=a.className.replace(RegExp("(^|\\s+)("+b.split(/\s+/).join("|")+")(?=(\\s+|$))","g")," "))}function z(a,b,d){a&&(a.className=a.className.replace(RegExp("(^|\\s+)("+b.split(/\s+/).join("|")+")(?=(\\s+|$))","g")," ")+" "+d)}function H(a,b,d){t(a,"mouseover",function(){D(this,b);d&&E(this,d)});t(a,"mouseout",function(){E(this,b);d&&D(this,d)})}function ia(a,b,d){if(typeof d===
"boolean")d?D(a,b):E(a,b);else V(a,b)?E(a,b):D(a,b)}function L(a){a&&a.style&&(a.style.display="block")}function x(a){a&&a.style&&(a.style.display="none")}function ka(a){a&&a.parentNode&&a.parentNode.removeChild(a)}function t(a,b,d){if(a.addEventListener)a.addEventListener(b,d,false);else{a["e"+b+d]=d;a[b+d]=function(){return a["e"+b+d](v.event)};a.attachEvent("on"+b,a[b+d])}}function Q(a){if(a){a.preventDefault&&a.preventDefault();a.returnValue=false}}function ea(a){if(!a.target)a.target=a.srcElement||
u;if(a.target.nodeType===3)a.target=a.target.parentNode;return a.target}function aa(a){a.setAttribute("unselectable","on");a.style.MozUserSelect="none";t(a,"selectstart",ga)}function J(){if(!o){o=true;if(P){for(var a,b=0;a=P[b++];)a();P=null}}}function pa(){if(!W){W=true;if(u.readyState==="complete")return J();if(u.addEventListener)u.addEventListener("DOMContentLoaded",function(){u.removeEventListener("DOMContentLoaded",arguments.callee,false);J()},false);else if(u.attachEvent){u.attachEvent("onreadystatechange",
function(){if(u.readyState==="complete"){u.detachEvent("onreadystatechange",arguments.callee);J()}});u.documentElement.doScroll&&v==v.top&&function(){if(!o){try{u.documentElement.doScroll("left")}catch(a){setTimeout(arguments.callee,0);return}J()}}()}t(v,"load",J)}}function K(a){var b=new Date;b.setTime(a?parseFloat(a)+K.timeSkew:(new Date).getTime());this.date=b}function w(a,b,d){d=h({locale:w.locale},d);d=w.dictionary[d.locale];c(d)||(d={});a=d[a]===X?a:d[a];if(b){ba=b;for(var f in b)a=a.replace(/\{\{(.*?)\}\}/g,
A)}return a}function y(a,b){this.element=a;this.options=h({},y.defaults,b);this._init()}function la(a){a=a.getElementsByTagName("*");for(var b,d,f={},i=a.length-1;i>-1;i--){b=a[i];if((d=b.id)&&d.indexOf(":")==0)f[d.substring(1,d.length)]=b}return f}function F(a){var b=u.createElement("div");b.innerHTML=a;return b=b.firstChild}function T(a,b,d){function f(i,k){this.id=na++;this.name=a;this.className="webim-"+a;this.options=h({},f.defaults,k);if(this.element=i||this.template&&F(this.template())||this.options.template&&
F(I(this.options.template))){this.options.className&&D(this.element,this.options.className);this.$=la(this.element)}N(this._init)&&this._init();N(this._initEvents)&&this._initEvents()}f.defaults=b;h(f.prototype,r,T.prototype,d);y[a]=f}function ma(a,b){y.apps[a]=b||{}}function Z(a,b){return b?a=="b"||a=="buddy"||a=="unicast"?"b_"+b:"r_"+b:a}function $(){u.selection&&(this.caretPos=u.selection.createRange())}var ja=webim.idsArray,N=webim.isFunction,fa=webim.isArray,c=webim.isObject,e=webim.trim,g=webim.makeArray,
h=webim.extend,j=webim.each,l=webim.grep,r=webim.objectExtend,s=webim.map,o=false,P=[],W=false;K.timeSkew=0;K.init=function(a){K.timeSkew=(new Date).getTime()-parseFloat(a)};h(K.prototype,{getTime:function(){var a=this.date,b=a.getHours();a=a.getMinutes();if(a<10)a="0"+a;return b+":"+a+""},getDay:function(a){var b=this.date;if(a){a=new Date;a.setHours(0);a.setMinutes(0);a.setSeconds(0);a.setMilliseconds(0);a=a.getTime()-b.getTime();if(a<=0)return w("dt:today");else if(a<864E5)return w("dt:yesterday")}return w("dt:monthdate",
...
n);p&&p.removeMember(q.id,q.nick)});k.bind("collapse",function(){i.set("minimize_layout",true)});k.bind("expand",function(){i.set("minimize_layout",false)});k.bind("displayUpdate",function(){a._updateStatus()});b.bind("message",function(n){for(var q=false,p=n.length,B,Y=b.data.user.id,O,R,C=0;C<p;C++){B=n[C];O=B.id;type=B.type;(R=k.chat(type,O))&&R.status("");if(!R){B.type==="unicast"?a.addChat(type,O,null,null,B.nick):a.addChat(type,O);R=k.chat(type,O)}R&&i.get("msg_auto_pop")&&!k.activeTabId&&k.focusChat(O);
R.window.notifyUser("information","+1");O=R.window.pos;O==-1&&k.setNextMsgNum("+1");O==1&&k.setPrevMsgNum("+1");if(B.from!=Y)q=true}if(q){G.play("msg");qa(w("new message"),5)}});b.bind("status",function(n){j(n,function(q,p){var B=b.data.user.id,Y=p.from;if(!(B!=p.to&&B!=p.from))(B=k.chat("buddy",Y))&&B.status(p.show)})});f.bind("unicast",function(n,q){var p=k.chat("unicast",n);p&&p.history.add(q)});f.bind("multicast",function(n,q){var p=k.chat("multicast",n);p&&p.history.add(q)});f.bind("clear",function(n,
...
t(b.prev,"mousedown",function(){a._slide(1)});t(b.prev,"mouseup",function(){a._slideUp()});aa(b.prev);t(b.expand,"click",function(){if(!a.isMinimize())return false;a.expand();a.trigger("expand");return false});t(b.collapse,"click",function(){if(a.isMinimize())return false;a.collapse();a.trigger("collapse");return false});H(b.collapse,"ui-state-hover","ui-state-default");H(b.expand,"ui-state-hover","ui-state-default")},isMinimize:function(){return V(this.$.layout,"webim-layout-minimize")},collapse:function(){this.isMinimize()||
...
'="'+i+'"'}var d;return function(f,i){d="";i&&c(i)&&j(i,b);return f.replace(/(https?:\/\/|www\.)([^\s<]+)/ig,a)}}();y.history.defaults.parseMsg=true;M.add("history","parseMsg",{render:function(a,b){var d=b.msg.body;d=S(d);d=oa(d,{target:"_blank"});b.msg.body=d}});y.history.defaults.emot=true;M.add("history","emot",{render:function(a,b){b.msg.body=y.emot.parse(b.msg.body)}});T("emot",{template:'<div class="webim-emot ui-widget-content"><%=emots%></div>'},{_init:function(){var a=this,b=a.element;j(b.firstChild.childNodes,
...
webim.ui.emot._q,d=webim.ui.emot.emots;b&&j(b,function(f,i){var k=d[i],m=k.src,n=k.t?k.t:k.q[0],q=[];q.push('<img src="');q.push(m);q.push('" title="');q.push(n);q.push('" alt="');q.push(k.q[0]);q.push('" />');f=S(f);f=f.replace(RegExp("(\\"+".$^*\\[]()|+?{}:<>".split("").join("|\\")+")","g"),"\\$1");a=a.replace(RegExp(f,"g"),q.join(""))});return a}});T("chat",{tpl_header:'<div><div id=":user" class="webim-user"> \t\t\t<a id=":userPic" class="webim-user-pic ui-corner-all ui-state-active" href="#id"><img width="50" height="50" src="" defaultsrc="" onerror="var d=this.getAttribute(\'defaultsrc\');if(d && this.src!=d)this.src=d;" class="ui-corner-all"></a> \t\t\t<span id=":userStatus" title="" class="webim-user-status">&nbsp;</span> \t\t     </div></div>',
...
$:this.$,history:this.history},a)},plugins:{}});y.chat.defaults.emot=true;M.add("chat","emot",{init:function(a,b){var d=b.self,f=new y.emot;f.bind("select",function(k){d.focus();d.insert(k,true)});var i=F(I('<a href="#chat-emot" title="<%=emot%>"><em class="webim-icon webim-icon-emot"></em></a>'));t(i,"click",function(k){Q(k);f.toggle()});b.$.toolContent.appendChild(f.element);b.$.tools.appendChild(i)},send:function(){}});y.chat.defaults.clearHistory=true;M.add("chat","clearHistory",{init:function(a,
b){var d=b.self,f=F(I('<a href="#chat-clearHistory" title="<%=clear history%>"><em class="webim-icon webim-icon-clear"></em></a>'));t(f,"click",function(i){Q(i);d.trigger("clearHistory",[d.options.info])});b.$.tools.appendChild(f)}});y.chat.defaults.block=true;M.add("chat","block",{init:function(a,b){var d=b.self,f=d.options.info.blocked,i=d.options.info.nick,k=F('<a href="#chat-block" style="display:'+(f?"none":"")+'" title="'+w("block group",{name:i})+'"><em class="webim-icon webim-icon-unblock"></em></a>'),
m=F('<a href="#chat-block" style="display:'+(f?"":"none")+'" title="'+w("unblock group",{name:i})+'"><em class="webim-icon webim-icon-block"></em></a>');t(k,"click",function(n){Q(n);x(k);L(m);d.trigger("block",[d.options.info])});t(m,"click",function(n){Q(n);x(m);L(k);d.trigger("unblock",[d.options.info])});b.$.tools.appendChild(k);b.$.tools.appendChild(m)}});y.chat.defaults.member=true;h(y.chat.prototype,{addMember:function(a,b,d){var f=this,i=f.memberLi;if(!i[a]){var k=F('<li><a class="'+(d?"ui-state-disabled":
"")+'" href="'+a+'">'+b+"</a></li>");t(k.firstChild,"click",function(m){Q(m);d||f.trigger("select",[{id:a,nick:b}])});i[a]=k;f.$.member.appendChild(k);f.$.memberCount.innerHTML=parseInt(f.$.memberCount.innerHTML)+1}},removeMember:function(a){var b=this.memberLi[a];if(b){this.$.member.removeChild(b);delete this.memberLi[a];this.$.memberCount.innerHTML=parseInt(this.$.memberCount.innerHTML)-1}}});M.add("chat","member",{init:function(a,b){var d=b.$;b.self.memberLi={};var f=F(I('<div class="webim-member ui-widget-content ui-corner-left"><iframe id=":bgiframe" class="webim-bgiframe" frameborder="0" tabindex="-1" src="about:blank;" ></iframe><h4><%=room member%>(<span id=":memberCount">0</span>)</h4><ul id=":ul"></ul></div>')),
...
b.pic_url||b.default_pic_url);a=a.nextSibling;a.innerHTML=b.nick;a=a.nextSibling;a.innerHTML=b.status||"&nbsp;";return a},_addOne:function(a,b){var d=this,f=d.li,i=a.id,k=d.$.ul;if(!f[i]){d.size++;if(!a.default_pic_url)a.default_pic_url="";a.status=a.status||"&nbsp;";a.show=a.show||"available";a.human_show=w(a.show);a.pic_url=a.pic_url||"";f=f[i]=F(I(d.options.tpl_li,a));t(f.firstChild,"click",function(q){Q(q);d.trigger("select",[a]);this.blur()});var m=d.groups,n=w(a.group||"friend");m=m[n];if(!m){m=
